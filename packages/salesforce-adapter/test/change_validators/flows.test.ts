...
describe('flows change validator', () => {
  ...
  describe('deactivate a flow', () => {
    ...
    it('should have info when trying to deactivate a flow', async () => {
      ...
      changeValidator = flowsChangeValidator(buildFetchProfile({ fetchParams: { preferActiveFlowVersions: true } }), true, client)
  ...
  describe('adding and editing an active flow', () => {
    ...
    describe('non-sandbox env', () => {
      ...
      beforeEach(() => {
        changeValidator = flowsChangeValidator(buildFetchProfile({ fetchParams: { preferActiveFlowVersions: true } }), false, client)
      })
